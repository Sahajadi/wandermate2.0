...
import BGImg from "../assets/image/bg8.jpg";
import HeaderImage from "../assets/image/headerImg5.jpg";
        ...
        <>
            ...
            >
                ...
                <motion.div
                    ...
                    className={`h-screen w-[80%] sm:hidden fixed top-0 right-0 bg-white z-50 rounded-lg`}
                ...
                >
                    {
                        landingHeaderLinks.map((item) => (
                            <>
                                <Link
                                    className="flex front-bold text-gray-500 text-lg py-4 px-4 cursor-pointer hover:bg-gray-100 hover:rounded-lg"
                                    key={item.id}>
                                    to={item.link}
                                    {item.link}
                                </Link>
